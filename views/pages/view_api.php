...
<body>
	...
	<main>
		...
		<section>
			...
			<p><a href="../ctrls/apiHackathonsProjets.php" target="_blank">./apiHackathonsProjets.php</a></p>
		</section>
		<section>
			<h3>Tous les hackathons avec leurs projet d'une année donnée: </h3>
			<p><a href="../ctrls/apiHackathonsProjets.php?annee=2024" target="_blank">./apiHackathonsProjets.php?annee=2024</a></p>
			<p><a href="../ctrls/apiHackathonsProjets.php?annee=2023" target="_blank">./apiHackathonsProjets.php?annee=2023</a></p>
		</section>
		<section>
			<h3>Le hackathon avec ses projets pour un id saisi : </h3>
			<form action="../ctrls/apiHackathonsProjets.php" target="_blank" method="GET">
