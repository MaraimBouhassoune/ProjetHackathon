...
class Participant
{
   ...
   public function __construct()
   {
      ...
      } else if (func_num_args() == 1) { // on a les 2 arguments dans un tableau
         $this->idParticipant = 0;     // pas d'id : on met 0 en dur
         $this->idHackathon = func_get_arg(0);       // argument 1 : $loginParticipant
      }
   ...
   public function getIdHackathon(): string
   {
